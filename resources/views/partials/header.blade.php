...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li><a href="{{ route('shop.cart') }}" style="margin-left:62em;"><span class="glyphicon glyphicon-shopping-cart"></span> Shopping Cart</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
      ...
      @else
        ...
        <li><a href="{{ route('user.signin') }}"><span class="glyphicon glyphicon-user"></span> Sign In</a></li>
      @endif
    </ul>
  </div>
</nav>
